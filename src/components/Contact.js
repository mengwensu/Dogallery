...
const Contact = () => {
  return (
    <div className='Contact'>
        ...
        <h3 className='contactInfo'><For any further inquiriers about the website, suggestions, or other questions please use the following contact information. p={1} /></h3>
